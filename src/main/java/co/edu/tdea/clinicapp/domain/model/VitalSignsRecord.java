...
public class VitalSignsRecord {
    ...
    public VitalSignsRecord(LocalDateTime recordedAt, String nurseIdNumber,
        ...
        if (recordedAt == null) throw new IllegalArgumentException("Registrado en es necesario");
        if (nurseIdNumber == null || nurseIdNumber.isBlank())
            throw new IllegalArgumentException("El numero de ID de la enfermera es requerido.");
