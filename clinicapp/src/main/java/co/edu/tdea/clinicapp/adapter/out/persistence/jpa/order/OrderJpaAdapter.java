...
public class OrderJpaAdapter implements OrderRepository {
    ...
    // (Opcional) Alias por compatibilidad si algún service aún llama a ...IdNumber
    @Override
    public List<Order> findAllByPatientIdNumber(String patientIdNumber) {
        return findAllByPatientId(patientIdNumber);
    }
