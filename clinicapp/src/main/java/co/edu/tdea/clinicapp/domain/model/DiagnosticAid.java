...
public class DiagnosticAid {
    ...
    public void setName(String name) {
        if (name == null || name.isBlank()) throw new IllegalArgumentException("Un nombre es necesario.");
        this.name = name.trim();
    }

    public int getUnitCost() { return unitCost; }
    public void setUnitCost(int unitCost) {
        if (unitCost < 0) throw new IllegalArgumentException("El coste de la unidad debe ser >= 0");
