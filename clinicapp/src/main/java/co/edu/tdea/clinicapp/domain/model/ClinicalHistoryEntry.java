...
public class ClinicalHistoryEntry {
    ...
    public ClinicalHistoryEntry(
        ...
        if (attendedAt == null) throw new IllegalArgumentException("Se requiere asistente");
        if (doctorIdNumber == null || doctorIdNumber.isBlank()) throw new IllegalArgumentException("El numero de ID del doctor es necesario.");
        if (diagnosis == null || diagnosis.isBlank()) throw new IllegalArgumentException("Un diagnostico es necesario.");
